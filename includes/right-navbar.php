        ...
        <aside id="nav2">
          <ul>
            <form id="form" action="./index.php" method="post">
              ...
              <li><div class="icons"><button type="submit" name="medicaments"><i class="fa fa-medkit"></i></div></button><div class="linktitle">
                <input class="subm" type="submit" name="animaux" value="Médicaments">

              </li>
              <li><div class="icons"><button type="submit" name="profil"><i class="fa fa-user"></i></div></button><div class="linktitle">
                  <input class="subm" type="submit" name="profil" value="Profil             ">
              </li>
              
              <li><div class="icons"><a style="text-decoration: none;color: grey;" href="./logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i></i></i></div><div style="color: grey;" class="linktitle">Déconnexion</div></a></li>
            </form>
          </ul>
        </aside>
